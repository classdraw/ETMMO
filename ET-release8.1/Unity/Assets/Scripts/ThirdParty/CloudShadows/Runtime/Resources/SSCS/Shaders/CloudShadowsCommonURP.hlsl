#ifndef SSCS_URP_SHADOWS
#define SSCS_URP_SHADOWS

#ifdef USE_URP
    #define UnityObjectToClipPos(x) TransformObjectToHClip(x.xyz)

    float4 SSCS_ComputeScreenPos(float4 pos)
    {
        float4 o = pos * 0.5f;
    ...
    #ifndef ComputeScreenPos
    #define ComputeScreenPos SSCS_ComputeScreenPos
    #endif
#endif
