// Simple URP Lambert diffuse + tangent-space normal map.
Shader "Universal Render Pipeline/Bumped Diffuse"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                output.tangentWS = float4(normInputs.tangentWS, input.tangentOS.w * GetOddNegativeScale());
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half3 albedo = albedoSample.rgb * _Color.rgb;
                half alpha = albedoSample.a * _Color.a;
                ...
                half3 color = albedo * (mainLight.color * mainLight.distanceAttenuation * mainLight.shadowAttenuation
